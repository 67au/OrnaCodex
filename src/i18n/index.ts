...
const currentLocale = useLocalStorage('locale', (browserLocale in LANGS) ? LANGS[browserLocale] : fallbackLocale);

// fix store locale error
if (!(Object.values(LANGS).includes(currentLocale.value))) {
