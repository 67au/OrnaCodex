...
<template>
  <template v-if="appState.loading">
    <v-dialog :model-value="appState.loading" max-width="320" persistent>
    ...
    <v-container v-if="!appState.loading && !appState.updated">
  ...
  <template v-if="!appState.loading && appState.finished">
    <slot></slot>
  </template>
</template>
